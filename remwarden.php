...
{
$iphno=$_POST['name'];
$sql=$conn->query("delete from warden where name='".$iphno."'  ");
if($sql)
{
echo"<script>alert('Warden Succssfully Deleted');</script>";
}
}
?>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Remove Warden </h2>
...
<?php
  $sql = mysqli_query($conn, "SELECT name From warden");
