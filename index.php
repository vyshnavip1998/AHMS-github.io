...
if(isset($_POST['login']))
{
	$id1 = $_POST['ph'];
		$pwd = $_POST['password'];
		$hloc=$_POST['hloc'];
		$sql = "SELECT * FROM warden WHERE wphno=$id1";
...
<body>
	<div class="brand clearfix">
		<a href="ahms.php" class="logo" style="font-size:16px;">Athurashram Hostel System</a>
...
?>
									...
									<input type="number" placeholder="Phone number" name="ph" class="form-control mb">
