...
$email=$_POST['email'];
$pass=$_POST['pass'];
$sql=$conn->query("INSERT INTO board(bphno,name,email,pass)VALUES('$bphno','$name','$email','$pass')");
if($sql)
{
echo"<script>alert('Board Member Succssfully register');</script>";
}
}
?>
...
<label class="col-sm-2 control-label">Board Member Phone Number : </label>
<div class="col-sm-8">
